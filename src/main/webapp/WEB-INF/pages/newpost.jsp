				...
				<form role="form" action="newpost" method="POST" novalidate>
					...
					<div class="row control-group">
						<div
							...
							<textarea rows="10" class="form-control"
								placeholder="New Blog Post" id="posttext" name="posttext"
								required
								data-validation-required-message="Please enter a new blog post"></textarea>
							<p class="help-block text-danger"></p>
						</div>
					</div>
					...
					<div class="row">
						<div
							...
							<p>Optional: add upload for background image</p>
							<p class="help-block text-danger"></p>
						</div>
					</div>
